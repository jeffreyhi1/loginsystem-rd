...
Const lg_phrase_contact_body = "<p>Das ist Ihre Kontakt-Seite. Normalerweise wäre es ein Formular sein. Zumindest sollten Sie bieten die Webmaster-Mail-Adresse.</p>"
Const lg_phrase_contact_webmaster = "an den Webmaster"
Const lg_phrase_contact_webmaster1 = "Bitte kontaktieren Sie den Webmaster um Unterstützung."
...
Const lg_phrase_enter_set_new_password_token = "Geben Sie Passwort-Reset-Token in das entsprechende Feld ein und drücken Sie die Absenden"
...
Const lg_phrase_form_error_cookie = "Cookies sind für die Anmeldung erforderlich. Bitte stellen Sie sicher Ihr Browser Cookies akzeptiert from this site."
Const lg_phrase_form_error_time = "Die Form, die vor Vollendung gestoppt. Bitte füllen Sie das Formular in weniger als 5 Minuten."
Const lg_phrase_form_error_token = "Es war ein Formfehler. Dies kann mit Hilfe Ihres Browsers Schaltfläche Zurück, um einen zuvor ausgefüllte Formular und neu vorzulegen es wieder hervorgerufen werden."
...
Const lg_phrase_oldpassword_does_not_match = "Das eingegebene Passwort stimmt nicht mit Ihrem gespeicherten Passwort überein. Wiederholen"
...
Const lg_phrase_password_new_title = "Bitte geben Sie Ihre gewünschtes Passwort ein. Dieses Feld ist obligatorisch."
Const lg_phrase_password_nomatch_confirm = "Das Passwort stimmt nicht mit der Bestätigungs-Passwort überein. Bitte wiederholen."
Const lg_phrase_password_title = "Bitte geben Sie Ihr Kennwort ein. Dieses Feld ist obligatorisch."
Const lg_phrase_password_too_soon = "Das Passwort ist das gleiche wie Ihr kürzlich verwendete Passwörter. Bitte wählen Sie ein anderes Kennwort."
Const lg_phrase_password_too_short_pre = "Das Kennwort ist mit zu wenigen charaters eingetragen. Die Mindestlänge eines Passwortes ist:"
...
Const lg_phrase_recover_password_success = "Der Anfrage zur Passwortwiederherstellung wurde erfolgreich verarbeitet.<p>Bitte folgen Sie den Anweisungen in der E-Mail, die an Sie gesendet wurde, um ein neues Passwort zu setzen.</p>"
...
Const lg_phrase_recover_password4 = "Wenn Sie keine Passwortwiederherstellung angefordert haben, wenden Sie sich an den Webmaster von"
...
Const lg_phrase_registration_mail4 = "Clicken Sie hier zur Überprüfung"
Const lg_phrase_registration_mail5 = "Falls der Link nicht funktioniert, besuchen Sie bitte <p>http://"
Const lg_phrase_registration_mail6 = "Kopieren Sie das Token fügen Sie es unten in das Formular ein. Dann klicken Sie auf ""Abschicken"""
...
Const lg_phrase_set_new_password_good_token = "Ihr Token war gültig. Geben Sie ein neues Passwort ein."
Const lg_phrase_set_new_password_success = "Ihr Passwort wurde erfolgreich geändert."
Const lg_phrase_set_new_password_token_expired = "Mehr als 24 Stunde sind vergangen, seit Sie ein Passwort-Wiederherstellungs-Token angefordert haben."
...
Const lg_phrase_verify_expired = "Mehr als 24 Stunden seit Ihrer Anmeldung verstrichen."
Const lg_phrase_verify_login = "Sie können sich nun mit Ihrem Konto anmelden."
Const lg_phrase_verify_newtoken = "Klicken Sie hier, um einen neuen Freischalt code zu generieren."
...
Const lg_term_ip = "IP"
Const lg_term_issue_verification_token = "Ausgabe des Verification Tokens"
Const lg_term_language = "<meta name=""language"" content=""de-DE"" />"
Const lg_term_log_out = "Log Aus"
...
Const lg_term_registration_verification = "Überprüfung der Registrierung"
Const lg_term_remember = true
Const lg_term_rememberme = "Angemeldet bleiben"
Const lg_term_remove_registration = "Registrierung löschen"
