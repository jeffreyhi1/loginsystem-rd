          ...
          <div id="login-system">
			...
			<% If message <> lg_phrase_password_changed Then %>
				...
				<fieldset>
				  ...
				  <label for="newpassword"><%=lg_term_password%>&nbsp;</label><br /><input id="password" name="password" type="password" size="25" maxlength="255" autocomplete="off" title="<%=lg_phrase_password_title%>" /><span class="field_normal"><%=lg_term_required%></span><br />
