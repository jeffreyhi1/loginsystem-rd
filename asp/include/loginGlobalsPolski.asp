...
'* 
'* Version: alpha 0.5a - Polish/polski - ASP
'******************************************************************************************************************
Dim lg_filename
...
Const lg_phrase_password_too_soon = "Wybrane hasło jest takie samo jak jedno z ostatnio używanych haseł. Proszę, wybierz inne hasło."
Const lg_phrase_password_too_short_pre = "Wprowadzone hasło jest za krótkie. Minimalna długość hasła to:"
Const lg_phrase_password_too_short_post = "liter, symboli i cyfr."
Const lg_phrase_password_too_simple = "Wprowadzone hasło jest zbyt proste. Wpisz hasło, które składa się z wielu przypadkowych znaków będących mieszanką symboli, małych i wielkich liter oraz cyfr."
...
Const lg_phrase_website_title = "Proszę, podaj adres swojej strony internetowej."
...
Const lg_term_medium = "DOBRE"
Const lg_term_name = "Imię i nazwisko"
Const lg_term_new = "Nowe"
Const lg_term_new_password = "Nowe hasło"
Const lg_term_poor = "BARDZO SŁABE"
