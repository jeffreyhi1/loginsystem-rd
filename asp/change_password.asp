		...
		If newpassword=confirm Then
			...
			if oldpasshashconfirm=oldpasshash Then
				...
				If numAffected=1 Then
					...
					mailBody = mailBody & lg_term_via_email & " " & lg_webmaster_email & " " & lg_term_immediately & "<br>"
					mailBody = mailBody & lg_term_or & " " & lg_term_at & "<a href=""" & lg_contact_form & """>" & lg_term_contact_form & "</a><br>"
