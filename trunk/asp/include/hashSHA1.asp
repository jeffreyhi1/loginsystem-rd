...
'*******************************************************************************************************************
'* HASH SHA1
'* Last Modification: 10 AUG 2000 Mark G. Jager
'* Version:  1.0
'* On Entry: None
'* Input:    String to hash
'* Output:   SHA1 Hashed String
'* On Exit:  None
'******************************************************************************************************************
...
'
    ...
    'strK(0) = "5A827999"
    strK(0) = Application("strK1")
    strK(1) = Application("strK2")
    strK(2) = Application("strK3")
    strK(3) = Application("strK4")
