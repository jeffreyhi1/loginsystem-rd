...
'*
'* Version: alpha 0.1c - Vietnamese - ASP
'*******************************************************************************************************************
Dim lg_filename
...
Const lg_term_contact = "Liên hệ"
Const lg_term_contact_form = "Mẫu liên hệ"
Const lg_term_content_language = "<meta http-equiv=""content-language"" content=""vi-VN"" />"
...
Const lg_term_form_error = "Mẫu Lỗi"
...
Const lg_term_language = "<meta name="language" content="vi-VN" />"
...
Const lg_term_project_home_link = "<a title=""Đăng nhập hệ thống trên Google Code"" href=""http://code.google.com/p/loginsystem-rd/"">http://code.google.com/p/loginsystem-rd/</a>"
...
Const lg_term_webloginproject_link = "<a title=""Đăng nhập Web dự án"" href=""http://www.webloginproject.com/index.php"">Đăng nhập Web dự án</a>"
...
Const lg_phrase_contact_body = "<p>Đây là trang của bạn liên hệ. Thông thường nó sẽ là một hình thức. Ở mức tối thiểu bạn nên cung cấp địa chỉ email của Webmaster.</p>"
...
Const lg_phrase_forbidden_body = "<p><h1>Bạn không có quyền truy cập vào tài nguyên đó.</h1></p><p>Liên hệ với quản trị trang web tại:"
Const lg_phrase_form_error_cookie = "Cookies được yêu cầu để đăng nhập. Xin vui lòng bảo đảm trình duyệt của bạn chấp nhận cookies từ website này."
Const lg_phrase_form_error_time = "Hình thức quá hạn trước khi hoàn thành. Xin vui lòng điền vào mẫu trong chưa đầy 5 phút."
Const lg_phrase_form_error_token = "Có một lỗi hình thức. Điều này có thể được gây ra bằng cách sử dụng trình duyệt của bạn trở lại nút để trở về một hình thức trước đây đã hoàn thành và gửi lại nó."
