...
?>
			...
			<fieldset>
			  ...
			  <label for="userid"><?PHP echo lg_term_userid; ?></label><br /><input id="userid" name="userid" title="<?PHP echo lg_phrase_userid_title; ?>" type="text" size="20" maxlength="50" />&nbsp;<span class="field_normal"><?PHP echo lg_term_required; ?></span><br />
