...
*
* Version: alpha 0.5a - Danish/Dansk - PHP
******************************************************************************************************************/
...
define("lg_phrase_contact_body", "Dette er din kontakt side. Normalt ville det være en form. Som et minimum bør du give Webmaster e-mail-adresse.</p>")'
...
define("lg_phrase_default_body1", "Denne hjemmeside blev oprettet for at demonstrere at indarbejde Login System på din hjemmeside design.</p><p>Hvert websted kan begrebsliggøres som en skabelon. Fælles dele af en webside skabelon kan omfatte et banner, navigation, en hovedindhold område, og måske en sidefod med links betingelser for brug, Copyright detaljer, og Privacy Policy.</p><p>Det område, hvor du nu læser i &quot;Main Content Area&quot; på denne side. Dette er det område, hvor du vil indsætte HTML eller XHTML markup skabeloner, der giver Login System.</p><p>Besøg projektet hjem på Google Code på:");
define("lg_phrase_default_body2", ".</p><p>Eller besøge forskellige demo sider i en række af verdens sprog på");
...
define("lg_phrase_form_error_time", "Den form timeout før afslutning. Udfyld formularen i mindre end 5 minutter.");
