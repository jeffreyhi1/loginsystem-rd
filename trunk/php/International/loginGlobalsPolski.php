...
*
* Version: alpha 0.5a - Polish/polski - PHP
******************************************************************************************************************/
...
define("lg_phrase_password_too_soon", "Wybrane hasło jest takie samo jak jedno z ostatnio używanych haseł. Proszę, wybierz inne hasło.");
define("lg_phrase_password_too_short_pre", "Wprowadzone hasło jest za krótkie. Minimalna długość hasła to:");
define("lg_phrase_password_too_short_post", "liter, symboli i cyfr.");
define("lg_phrase_password_too_simple", "Wprowadzone hasło jest zbyt proste. Wpisz hasło, które składa się z wielu przypadkowych znaków będących mieszanką symboli, małych i wielkich liter oraz cyfr.");
...
define("lg_phrase_website_title", "Proszę, podaj adres swojej strony internetowej.");
