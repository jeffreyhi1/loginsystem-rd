          <div id="login-system">
			...
			<?PHP if ($message != lg_phrase_password_changed) { ?>
				...
				<form id="frm" name="frm" method="post" action="<?PHP echo $lg_filename ?>" onsubmit="return validate(this);">
				<fieldset>
				  ...
				  <label for="newpassword"><?PHP echo lg_term_password ?>&nbsp;</label><br><input id="password" name="password" type="password" size="25" maxlength="255" title="<?PHP echo lg_phrase_password_title ?>"><span class="field_normal"><?PHP echo lg_term_required ?></span><br>
				  ...
				  <?PHP echo writeToken() ?><input id="submit" name="submit" type="submit" value="<?PHP echo lg_term_change_password_button_text ?>">
				</fieldset>
				</form>
			<?PHP }else{ ?>
