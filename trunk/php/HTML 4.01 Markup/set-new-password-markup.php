			...
			<fieldset>
			  ...
			  <input type="submit" value="<?PHP echo lg_term_submit ?>"><?PHP echo writeTokenH() ?><input name="changePassword" type="hidden" value=""></p>
			</fieldset>
			</form>
			</div>
			<?PHP 
			...
			<fieldset>
			  ...
			  <input type="submit" value="<?PHP echo lg_term_submit ?>"><?PHP echo writeTokenH() ?><input name="changePassword" type="hidden" value="1"><input type="hidden" name="resettoken" value="<?PHP echo $resettoken ?>"></p>
			</fieldset>
			</form>
			</div>
			<?PHP
