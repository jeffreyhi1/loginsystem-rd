...
*
* Version alpha 0.5a - French/Français - PHP
******************************************************************************************************************/
...
define("lg_webmaster_email_link", '<a href="mailto:webmaster@example.com">Ouaibemestre</a>');
...
define("lg_phrase_contact_body", "<p>Ceci est votre page de contact. Habituellement, il serait une forme. Au minimum, vous devez fournir l'adresse email du webmaster.</p>")'
...
define("lg_phrase_enter_set_new_password_token", "entrer nouveau mot de passe jeton");
define("lg_phrase_enter_unlock_code", "Entrer le code de déblocage");
define("lg_phrase_forbidden_body", "<p><h1>Vous n'avez pas accès à cette ressource.</h1></p><p>Contactez le webmaster à l'adresse:");
define("lg_phrase_form_error_cookie", "Les cookies sont requis pour la connexion. S'il vous plaît vous assurer que votre navigateur accepte les cookies de ce site.");
define("lg_phrase_form_error_time", "Le formulaire a expiré avant la fin. S'il vous plaît remplir le formulaire en moins de 5 minutes.");
define("lg_phrase_form_error_token", "Il y avait une erreur de forme. Cela peut être causé par l'utilisation de votre navigateur bouton précédent pour revenir à une forme déjà rempli et re-soumettre.");
define("lg_phrase_is_logged_in","est enregistré dans.");
...
define("lg_phrase_password_too_soon", "Le mot de passe est le même que le mot de passe utilisé récemment. S'il vous plaît choisir un mot de passe différent.");
define("lg_phrase_password_too_short_pre", "Le mot de passe entré est faite de charaters trop peu. La longueur minimale du mot de passe:");
define("lg_phrase_password_too_short_post", "lettres, des chiffres et des symboles");
define("lg_phrase_password_too_simple", "Le mot de passe est trop simple. S'il vous plaît entrer un mot de passe qui a beaucoup de caractères aléatoires comprenant un mélange de lettres majuscules et minuscules, chiffres, et de symboles.");
...
define("lg_phrase_set_new_password_token_expired", "Plus de 24 heures ont passé depuis que vous avez demandé une récupération de mot de passe (jeton de sécurité expiré).");
...
define("lg_term_content_language", "<meta http-equiv=\"content-language\" content=\"fr-FR\" />");
...
define("lg_term_language", "<meta name=\"language\" content=\"fr-FR\" />");
define("lg_term_log_out", "Déconnectez-vous");
...
define("lg_term_project_home_link", "<a title=\"Système de connexion sur Google Code\" href=\"http://code.google.com/p/loginsystem-rd/\">http://code.google.com/p/loginsystem-rd/</a>");
...
define("lg_term_webloginproject_link", "<a title=\"Projet de connexion Web\" href=\"http://www.webloginproject.com/index.php\">Projet de connexion Web</a>");
