...
?>
    		...
    		<form id="frm" method="post" action="<?PHP echo $lg_filename; ?>" onsubmit="return validate(this);">
    		  <fieldset>
    		    ...
    		    <input id="password" name="password" title="<?PHP echo lg_phrase_password_new_title; ?>" type="password" size="20" maxlength="255" autocomplete="off">
    		    <span class="field_normal"><?PHP echo lg_term_required; ?></span><br>
    		    <label for="confirm"><?PHP echo lg_term_confirm; ?></label><br>
    		    <input id="confirm" name="confirm" title="<?PHP echo lg_phrase_confirm_title; ?>" type="password" size="20" maxlength="255" autocomplete="off">
    		    <span class="field_normal"><?PHP echo lg_term_required; ?></span><br>
